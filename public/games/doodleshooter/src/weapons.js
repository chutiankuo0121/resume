...
export class Gun extends ViewModel {
  ...
  fireRay(origin, dir) {
    ...
    // 子弹只在场景与敌人之间取最近命中，保持遮挡和原版伤害衰减。
    if (hitW && hitW.box && hitW.box.data.breakable && (!hitE || hitW.dist < hitE.dist) && ctx.breakHit) {
