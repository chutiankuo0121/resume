...
- Exit: from 2.1, the existing Elimar exit transform applied to the orbit's final pose. The portal starts at 2.39 and expands over 0.2 units; the opening ends at 2.63. Compared with the previous 2.44 start, this advances the portal by 0.05 units (approximately two wheel notches under the existing calibration). The journey shortens by 27.5svh on desktop or 23svh on mobile, preserving the entry, reading orbit, exit camera and reveal speeds.
