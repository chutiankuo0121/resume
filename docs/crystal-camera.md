...
- Exit: from 2.1, the existing Elimar exit transform applied to the orbit's final pose. The portal starts at 2.36 and expands over 0.2 units; the opening ends at 2.6. This removes the previous 0.08-unit delay (approximately three wheel notches) while preserving the orbit and reveal speeds.
