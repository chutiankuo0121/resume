...
export class Player
{
    ...
    setInputs()
    {
        this.game.inputs.addActions([
            { name: 'forward',               categories: [ 'wandering', 'racing' ], keys: [ 'Keyboard.ArrowUp', 'Keyboard.KeyW', 'Gamepad.up', 'Gamepad.r2' ] },
            { name: 'right',                 categories: [ 'wandering', 'racing' ], keys: [ 'Keyboard.ArrowRight', 'Keyboard.KeyD', 'Gamepad.right' ] },
            { name: 'backward',              categories: [ 'wandering', 'racing' ], keys: [ 'Keyboard.ArrowDown', 'Keyboard.KeyS', 'Gamepad.down', 'Gamepad.l2' ] },
            { name: 'left',                  categories: [ 'wandering', 'racing' ], keys: [ 'Keyboard.ArrowLeft', 'Keyboard.KeyA', 'Gamepad.left' ] },
            ...
            { name: 'interact',              categories: [ 'wandering', 'racing' ], keys: [ 'Keyboard.Enter', 'Keyboard.KeyE', 'Keyboard.KeyF', 'Gamepad.cross' ] },
            { name: 'honk',                  categories: [ 'wandering', 'racing' ], keys: [ 'Keyboard.KeyH', 'Gamepad.l3' ] },
        ])
    ...
    setDistanceDriven()
    {
        ...
        const localDistanceDriven = localStorage.getItem('astra:bruno:distanceDriven')
        ...
        {
            localStorage.removeItem('astra:bruno:distanceDriven')
    ...
    setTimePlayed()
    {
        const localTimePlayed = localStorage.getItem('astra:bruno:timePlayed')
        this.timePlayed = {}
        ...
        setInterval(() =>
        {
            localStorage.setItem('astra:bruno:timePlayed', this.timePlayed.all)
        }, 1000)
    }
    ...
    updatePostPhysics()
    {
        ...
        {
            localStorage.setItem('astra:bruno:distanceDriven', flooredDistanceDriven)
