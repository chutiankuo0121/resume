    ...
    async init()
    {
        ...
        const resourcesPromise = this.resourcesLoader.load(
            [
                ...
                [ 'oakTreesReferencesModel',               `oakTrees/oakTreesReferences-compressed.glb`,                                               'gltf' ],
            ...
            (toLoad, total) =>
            {
                ...
                window.dispatchEvent(new CustomEvent('portfolio:progress', { detail: 0.1 + 0.75 * (1 - toLoad / total) }))
            }
        )
