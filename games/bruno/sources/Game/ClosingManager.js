...
export class ClosingManager
{
    constructor()
    {
        ...
        this.game.inputs.addActions([
            { name: 'close', categories: [ 'modal', 'menu', 'racing', 'wandering' ], keys: [ 'Keyboard.Escape', 'Gamepad.cross' ] },
            { name: 'pause', categories: [ 'modal', 'menu', 'racing', 'wandering' ], keys: [ 'Gamepad.start' ] }
        ])
