import { readProgress, saveProgress, isCount } from '../../LocalProgress.js'
...
export class AltarArea extends Area
{
    constructor(model)
    {
        ...
        this.setCounter()
        this.setDeathZone()
        this.updateText(readProgress('altar', 0, isCount))
        this.progressUniform.value = (this.value % 3) / 3
        this.setAchievement()
    }
    ...
    setCounter()
    {
        ...
        this.font = `700 ${this.height}px "Amatic SC", "Bruno Han"`
    ...
    setDeathZone()
    {
        ...
        zone.events.on(
            ...
            () =>
            {
                ...
                saveProgress('altar', this.value)
                this.progressUniform.value = (this.value % 3) / 3
                // 每三次祭坛互动触发本地风暴，计时随游戏暂停。
                if(this.value % 3 === 0 && !this.game.tornado.running) {
                    this.game.tornado.start()
                    gsap.delayedCall(60, () => this.game.tornado.stop())
                }
