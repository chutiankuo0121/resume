...
import { attribute, color, float, Fn, mix, PI, PI2, positionGeometry, screenCoordinate, sin, texture, uniform, varying, vec2, vec4 } from 'three/tsl'
import { SceneryArea } from './SceneryArea.js'

export class LightGardenArea extends SceneryArea
{
    constructor(model)
    {
        super(model)
