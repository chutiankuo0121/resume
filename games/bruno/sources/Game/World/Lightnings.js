...
export class Lightnings
{
    constructor()
    {
        ...
        this.updateHitChances = () =>
        {
            this.hitChances = Math.max(0, this.game.weather.clouds.value) * Math.max(0, this.game.weather.electricField.value) * this.game.weather.humidity.value
        }
